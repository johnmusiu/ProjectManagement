...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3>Dashboard </h3>
        <h4>{{ Auth::User()->department->name }} Department: My Daily Report</h4>
    </div>
    ...
    <div class="panel-body">
        ...
        <table class="table table-bordered table-striped table-responsive">
            <caption class="text-center bg-primary"><strong>Tasks Assigned Today</strong></caption>
            <thead>
                <td>Task Name</td>
                <td>Due Date</td>
                <td>Status</td>
        ...
        <table class="table table-bordered table-striped table-responsive">
            <caption class="text-center bg-success"><strong>Tasks Completed Today</strong></caption>
            <thead>
                <td>Task Name</td>
                <td>Due Date</td>
                <td>Status</td>
        ...
        <table class="table table-bordered table-striped table-responsive">
            <caption class="text-center bg-warning"><strong>Tasks Pending Today</strong></caption>
            <thead>
                <td>Task Name</td>
                <td>Due Date</td>
                <td>Status</td>
